  ...
  return (
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <img class="img-1 mx-auto d-block" src="nikhita-s-NsPDiPFTp4c-unsplash.jpg" alt="" srcset="" />
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <img class="img-2 mx-auto d-block" src="church-of-the-king-j9jZSqfH5YI-unsplash.jpg" alt=""
          srcset="" />
